<div class="container px-6 py-8 mx-auto">
    <div class="flex justify-between" x-data="{newUser:false}">
        <h3 class="text-3xl font-bold text-gray-700">Users</h3>
        <button @click="newUser = true"
        ...
        <div class="fixed inset-0 z-10 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true"
            x-show="newUser" x-cloak>
            <div class="flex items-end justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                <div @click="newUser = ! newUser" class="fixed inset-0 transition-opacity bg-gray-500 bg-opacity-75"
                        ...
                        @forelse ($users as $user)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                    <div class="text-sm leading-5 text-gray-900">
                                        @foreach ($user->getRoleNames() as $item)
                                            <span
                                                class="px-4 py-1 mr-1 text-sm text-yellow-600 bg-yellow-200 rounded-full ">
                                                {{ $item }}
                                            </span>
                                        @endforeach
                                    </div>
                                ...
                                <td
                                    ...
                                    <span x-data="{editUser:false}">
                                        <button @click="editUser = true" class="px-4"><svg
                                        ...
                                        <div class="fixed inset-0 z-10 overflow-y-auto" aria-labelledby="modal-title"
                                            role="dialog" aria-modal="true" x-show="editUser" x-cloak>
                                            <div
                                                class="flex items-end justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                                                <div @click="editUser = ! editUser"
                                    ...
                                    <span x-data="{deleteUser:false}" @click.away="deleteUser = false"
                                        @close.stop="deleteUser = false" @users-deleted.window="deleteUser = false">
                                        <button @click="deleteUser = true" class="px-4"><svg
                                        ...
                                        <div class="fixed inset-0 z-10 overflow-y-auto" aria-labelledby="modal-title"
                                            role="dialog" aria-modal="true" x-show="deleteUser" x-cloak>
                                            <div class="flex items-end justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0"
                                                x-cloak>
                                                <div
                                                    ...
                                                    <div class="w-full h-full text-center">
                                                        <div class="flex flex-col justify-between h-full">
                                                            ...
                                                            <div
                                                                ...
                                                                <button type="button" @click="deleteUser = false"
