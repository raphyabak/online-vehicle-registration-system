<div class="container px-6 py-8 mx-auto">
    <div class="flex justify-between" x-data="{newPermission:false}">
        <h3 class="text-3xl font-bold text-gray-700">Permissions</h3>
        <button @click="newPermission = true"
        ...
        <div class="fixed inset-0 z-10 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true"
            x-show="newPermission" x-cloak>
            <div class="flex items-end justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                <div @click="newPermission = ! newPermission"
                        ...
                        @forelse ($permissions as $permission)
                            <tr>
                                ...
                                <td
                                    ...
                                    <span x-data="{editPermission:false}">
                                        <button @click="editPermission = true" class="px-4"><svg
                                        ...
                                        <div class="fixed inset-0 z-10 overflow-y-auto" aria-labelledby="modal-title"
                                            role="dialog" aria-modal="true" x-show="editPermission" x-cloak>
                                            <div
                                                class="flex items-end justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                                                <div @click="editPermission = ! editPermission"
                                                ...
                                                <div
                                                    ...
                                                    <div class="mt-5 md:mt-0 md:col-span-2">
                                                        ...
                                                        @livewire('admin.edit-permission', ['permission' =>
                                    ...
                                    <span x-data="{deletePermission:false}" @click.away="deletePermission = false"
                                        @close.stop="deletePermission = false"
                                        @permission-deleted.window="deletePermission = false">
                                            <button @click="deletePermission = true" class="px-4"><svg
                                            ...
                                            <div class="fixed inset-0 z-10 overflow-y-auto" aria-labelledby="modal-title"
                                                role="dialog" aria-modal="true" x-show="deletePermission" x-cloak>
                                                <div class="flex items-end justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0"
                                                    x-cloak>
                                                    <div
                                                        ...
                                                        <div class="w-full h-full text-center">
                                                            <div class="flex flex-col justify-between h-full">
                                                                ...
                                                                <p
                                                                    ...
                                                                    delete this permission {{ $permission->id }}?</p>
                                                                <div
