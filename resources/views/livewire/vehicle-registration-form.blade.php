    ...
    <form wire:submit.prevent='registerVehicle'>
        <div class="p-6 space-y-6">
            ...
            <div class="text-right">
                ...
                <button type="submit"
                    class="text-white bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-base px-6 py-3.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Register</button>
            </div>
        </div>
    </form>
</div>
