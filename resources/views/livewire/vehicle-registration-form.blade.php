<div class="container px-6 py-8 mx-auto">
    ...
    <form wire:submit.prevent='registerVehicle'>
        <div class="p-6 space-y-6">
            ...
            <div class="grid grid-cols-6 gap-6">
                ...
                <div class="col-span-6 sm:col-span-3">
                    <label for="vehicle_model" class="text-sm font-medium text-gray-900 block mb-2">Vehicle Model</label>
                ...
                <div class="col-span-6 sm:col-span-3">
                    <label for="vehicle_color" class="text-sm font-medium text-gray-900 block mb-2">Vehicle Color</label>
            ...
            <div class="text-right">
                ...
                <button type="submit" class="text-white bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-base px-6 py-3.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Register</button>
            </div>
        </div>
    </form>
</div>
