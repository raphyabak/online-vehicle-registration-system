<div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'" class="fixed inset-y-0 left-0 z-30 w-56 overflow-y-auto transition duration-300 transform bg-gray-900 lg:translate-x-0 lg:static lg:inset-0">
    <div class="flex items-center justify-center mt-8">
        <div class="flex items-center">
            ...
            <span class="mx-2 text-2xl font-semibold text-white">Vehicle E-Reg Board</span>
        </div>
    </div>
    ...
    <nav class="mt-10">
        ...
        <a class="flex items-center px-6 py-2 mt-4  @if (request()->is('my-vehicles'))
            ...
            <span class="mx-3">My Vehicle List</span>
        </a>

        <a class="flex items-center px-6 py-2 mt-4  @if (request()->is('register-vehicle'))
            text-gray-100 bg-gray-700 bg-opacity-35
            @else
            text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100
            @endif"
            href="{{url('register-vehicle')}}">
            <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z">
        ...
        <a class="flex items-center px-6 py-2 mt-4  @if (request()->is('renew-license'))
            ...
            <span class="mx-3">Renew License</span>
        ...
        <a class="flex items-center px-6 py-2 mt-4  @if (request()->is('change-vehicle-ownership'))
            ...
            <span class="mx-3">Change Vehicle Ownership</span>
        </a>
    </nav>
</div>
