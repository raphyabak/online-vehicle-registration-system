<div><form wire:submit.prevent='addRole'>
    <div class="overflow-hidden shadow sm:rounded-md">
        <div class="px-4 py-5 bg-white sm:p-6">
            ...
            <div class="grid grid-cols-6 gap-6 pt-4">
                ...
                <div class="col-span-12 sm:col-span-6">
                    <label for="country" class="block text-sm font-medium text-gray-700">Permission</label>
                    <select id="country" name="country" wire:model='permission'
    ...
    <div class="px-4 py-3 bg-gray-50 sm:px-6 sm:flex sm:flex-row-reverse">
        ...
        <button @click="newRole = false" type="button"
